...
class Principal extends Component {
  ...
  render() {
    return (
      ...
      <input type="text" value={this.state.Interes} onChange={this.handleChangeInteres} required placeholder="Ingresar Producto" />

      <div>

      </div>
      <h2 className='BottonDatos' onClick={this.ActualizarDato} >Estadisticas</h2>
      <div></div>
      </div>
      <QrReader
        className="qrimage"
